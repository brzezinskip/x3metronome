...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29117__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29117__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29117__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e29116){var _e = e29116;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___29143 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___29143)){
var seen_errors_29144 = temp__5733__auto___29143;
if(cljs.core.truth_(seen_errors_29144.has(self))){
} else {
seen_errors_29144.add(self);

var temp__5735__auto___29145 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___29145)){
var sense_29146 = temp__5735__auto___29145;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29146)].join(''));
} else {
}
}
} else {
