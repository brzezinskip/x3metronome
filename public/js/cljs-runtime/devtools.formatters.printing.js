...
var G__29399 = (i__4737__auto___29396 + (1));
i__4737__auto___29396 = G__29399;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq29347){
var G__29348 = cljs.core.first(seq29347);
var seq29347__$1 = cljs.core.next(seq29347);
var G__29349 = cljs.core.first(seq29347__$1);
var seq29347__$2 = cljs.core.next(seq29347__$1);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29348,G__29349,seq29347__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__29369_SHARP_){
return (!((cljs.core.meta(p1__29369_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29375__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e29379){var _e__28264__auto__ = e29379;
return false;
}})();
if(cljs.core.truth_(or__4126__auto__)){
return or__4126__auto__;
...
}catch (e29381){var _e__28264__auto__ = e29381;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__29384 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__29385 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__29385);

try{var map__29386 = opts;
var map__29386__$1 = (((((!((map__29386 == null))))?(((((map__29386.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__29386.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__29386):map__29386);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29386__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__29384);
}});
...
var temp__5733__auto___29415 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___29415)){
var managed_print_level_29416 = temp__5733__auto___29415;
var _STAR_print_level_STAR__orig_val__29390_29417 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__29391_29418 = managed_print_level_29416;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__29391_29418);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__29388_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__29388_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__29390_29417);
}} else {
job_fn();
}
