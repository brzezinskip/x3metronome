...
var G__40284 = o;
goog.object.set(G__40284,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__40285 = o;
goog.object.set(G__40285,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__40314.cljs$lang$applyTo = (function (arglist__40318){
...
var G__40286 = props;
var G__40286__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40286,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__40286);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40286__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__40287 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__40287,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__40287;
}
})(),id_class);
...
var G__40288 = (cljs.core.count(argv) - first_child);
switch (G__40288) {
case (0):
...
var vec__40289 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40289,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40289,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__40289,(2),null);
...
var temp__5739__auto___40340 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___40340 == null)){
} else {
var key_40341 = temp__5739__auto___40340;
(jsprops.key = key_40341);
}
...
var temp__5739__auto___40351 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___40351 == null)){
} else {
var key_40352 = temp__5739__auto___40351;
(jsprops.key = key_40352);
}
...
var temp__5739__auto___40356 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___40356 == null)){
} else {
var key_40357 = temp__5739__auto___40356;
(jsprops.key = key_40357);
}
...
var temp__5739__auto___40361 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___40361 == null)){
} else {
var key_40362 = temp__5739__auto___40361;
(jsprops.key = key_40362);
}
...
var temp__5739__auto___40364 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___40364 == null)){
} else {
var key_40365 = temp__5739__auto___40364;
(jsprops.key = key_40365);
}
