...
var G__29336 = devtools.prefs.pref(v);
v = G__29336;
continue;
} else {
return v;
...
}catch (e29287){var _e__28264__auto__ = e29287;
return false;
}})();
...
}catch (e29293){var _e__28264__auto__ = e29293;
return false;
}})();
...
}catch (e29296){var _e__28264__auto__ = e29296;
return false;
}}
}
});
...
var vec__29320 = devtools.munging.parse_constructor_info(constructor_fn);
...
return cljs.core.some((function (p1__29325_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__29325_SHARP_);
}),template);
});
