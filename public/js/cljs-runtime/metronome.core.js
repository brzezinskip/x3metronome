...
metronome.core.on_row_click = (function metronome$core$on_row_click(p__33264){
...
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33265__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194));
var timer_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33265__$1,new cljs.core.Keyword(null,"timer-fn","timer-fn",-731279340));
var running = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33265__$1,new cljs.core.Keyword(null,"running","running",1554969103));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33265__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var reps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33265__$1,new cljs.core.Keyword(null,"reps","reps",1391310856));
var countdown_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33265__$1,new cljs.core.Keyword(null,"countdown?","countdown?",-1555952325));
var countdown_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33265__$1,new cljs.core.Keyword(null,"countdown-value","countdown-value",-908866158));
return (function (){
...
metronome.core.counter_row = (function metronome$core$counter_row(p__33269){
...
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33270__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
var bg_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33270__$1,new cljs.core.Keyword(null,"bg-color","bg-color",455102491));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33270__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var with_let33272 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let33272","with-let33272",274094328));
var temp__5739__auto___33274 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___33274 == null)){
} else {
var c__28532__auto___33275 = temp__5739__auto___33274;
if((with_let33272.generation === c__28532__auto___33275.ratomGeneration)){
...
(with_let33272.generation = c__28532__auto___33275.ratomGeneration);
}


var init33273 = (with_let33272.length === (0));
var seconds_elapsed = ((init33273)?(with_let33272[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let33272[(0)]));
var running = ((init33273)?(with_let33272[(1)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let33272[(1)]));
var timer_fn = ((init33273)?(with_let33272[(2)] = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let33272[(2)]));
var reps = ((init33273)?(with_let33272[(3)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let33272[(3)]));
var countdown_QMARK_ = ((init33273)?(with_let33272[(4)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let33272[(4)]));
var countdown_value = ((init33273)?(with_let33272[(5)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((3))):(with_let33272[(5)]));
var res__28533__auto__ = (function (){
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["h-full flex flex-col flex-1 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(bg_color)," ",metronome.core.get_bg_opacity(seconds_elapsed,cadence)," justify-evenly"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),metronome.core.on_row_click(new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"seconds","seconds",-445266194),seconds_elapsed,new cljs.core.Keyword(null,"timer-fn","timer-fn",-731279340),timer_fn,new cljs.core.Keyword(null,"running","running",1554969103),running,new cljs.core.Keyword(null,"cadence","cadence",821204241),cadence,new cljs.core.Keyword(null,"reps","reps",1391310856),reps,new cljs.core.Keyword(null,"countdown?","countdown?",-1555952325),countdown_QMARK_,new cljs.core.Keyword(null,"countdown-value","countdown-value",-908866158),countdown_value], null))], null),metronome.core.text(desc),metronome.core.text(["Reps:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(reps))].join('')),metronome.core.text(cljs.core.deref(seconds_elapsed)),metronome.core.checkbox("Countdown?",cljs.core.deref(countdown_QMARK_),(function (p1__33268_SHARP_){
return p1__33268_SHARP_.stopPropagation(cljs.core.reset_BANG_(countdown_QMARK_,cljs.core.not(cljs.core.deref(countdown_QMARK_))));
}))], null);
});
var destroy__28531__auto___33276 = (function (){
return clearInterval(timer_fn);
});
if(reagent.ratom.reactive_QMARK_()){
if((with_let33272.destroy == null)){
(with_let33272.destroy = destroy__28531__auto___33276);
} else {
}
} else {
destroy__28531__auto___33276();
}
