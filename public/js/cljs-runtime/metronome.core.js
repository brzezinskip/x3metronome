...
metronome.core.on_row_click = (function metronome$core$on_row_click(p__29254){
...
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29255__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194));
var timer_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29255__$1,new cljs.core.Keyword(null,"timer-fn","timer-fn",-731279340));
var running = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29255__$1,new cljs.core.Keyword(null,"running","running",1554969103));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29255__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var reps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29255__$1,new cljs.core.Keyword(null,"reps","reps",1391310856));
return (function (){
...
metronome.core.counter_row = (function metronome$core$counter_row(p__29257){
...
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29258__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
var bg_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29258__$1,new cljs.core.Keyword(null,"bg-color","bg-color",455102491));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29258__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var with_let29260 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let29260","with-let29260",2065388991));
var temp__5739__auto___29262 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___29262 == null)){
} else {
var c__28532__auto___29263 = temp__5739__auto___29262;
if((with_let29260.generation === c__28532__auto___29263.ratomGeneration)){
...
(with_let29260.generation = c__28532__auto___29263.ratomGeneration);
}


var init29261 = (with_let29260.length === (0));
var seconds_elapsed = ((init29261)?(with_let29260[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let29260[(0)]));
var running = ((init29261)?(with_let29260[(1)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let29260[(1)]));
var timer_fn = ((init29261)?(with_let29260[(2)] = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let29260[(2)]));
var reps = ((init29261)?(with_let29260[(3)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let29260[(3)]));
...
var destroy__28531__auto___29264 = (function (){
return clearInterval(timer_fn);
});
if(reagent.ratom.reactive_QMARK_()){
if((with_let29260.destroy == null)){
(with_let29260.destroy = destroy__28531__auto___29264);
} else {
}
} else {
destroy__28531__auto___29264();
}
