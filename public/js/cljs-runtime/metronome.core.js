...
var G__35747_35759 = cljs.core.deref(countdown_value);
(speak.cljs$core$IFn$_invoke$arity$1 ? speak.cljs$core$IFn$_invoke$arity$1(G__35747_35759) : speak.call(null,G__35747_35759));
...
var G__35748 = cljs.core.deref(seconds);
return (speak.cljs$core$IFn$_invoke$arity$1 ? speak.cljs$core$IFn$_invoke$arity$1(G__35748) : speak.call(null,G__35748));
}
}
}),(1000)));
});
metronome.core.on_row_click = (function metronome$core$on_row_click(p__35749){
...
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35750__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194));
var timer_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35750__$1,new cljs.core.Keyword(null,"timer-fn","timer-fn",-731279340));
var running = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35750__$1,new cljs.core.Keyword(null,"running","running",1554969103));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35750__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var reps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35750__$1,new cljs.core.Keyword(null,"reps","reps",1391310856));
var countdown_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35750__$1,new cljs.core.Keyword(null,"countdown?","countdown?",-1555952325));
var countdown_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35750__$1,new cljs.core.Keyword(null,"countdown-value","countdown-value",-908866158));
return (function (){
...
metronome.core.counter_row = (function metronome$core$counter_row(p__35754){
...
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35755__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
var bg_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35755__$1,new cljs.core.Keyword(null,"bg-color","bg-color",455102491));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35755__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var with_let35757 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let35757","with-let35757",-1171397109));
var temp__5739__auto___35760 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___35760 == null)){
} else {
var c__28532__auto___35761 = temp__5739__auto___35760;
if((with_let35757.generation === c__28532__auto___35761.ratomGeneration)){
...
(with_let35757.generation = c__28532__auto___35761.ratomGeneration);
}


var init35758 = (with_let35757.length === (0));
var seconds_elapsed = ((init35758)?(with_let35757[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let35757[(0)]));
var running = ((init35758)?(with_let35757[(1)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let35757[(1)]));
var timer_fn = ((init35758)?(with_let35757[(2)] = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let35757[(2)]));
var reps = ((init35758)?(with_let35757[(3)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let35757[(3)]));
var countdown_QMARK_ = ((init35758)?(with_let35757[(4)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let35757[(4)]));
var countdown_value = ((init35758)?(with_let35757[(5)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((3))):(with_let35757[(5)]));
var res__28533__auto__ = (function (){
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["h-full flex flex-col flex-1 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(bg_color)," ",metronome.core.get_bg_opacity(seconds_elapsed,cadence)," justify-evenly"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),metronome.core.on_row_click(new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"seconds","seconds",-445266194),seconds_elapsed,new cljs.core.Keyword(null,"timer-fn","timer-fn",-731279340),timer_fn,new cljs.core.Keyword(null,"running","running",1554969103),running,new cljs.core.Keyword(null,"cadence","cadence",821204241),cadence,new cljs.core.Keyword(null,"reps","reps",1391310856),reps,new cljs.core.Keyword(null,"countdown?","countdown?",-1555952325),countdown_QMARK_,new cljs.core.Keyword(null,"countdown-value","countdown-value",-908866158),countdown_value], null))], null),metronome.core.text(desc),metronome.core.text(["Reps:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(reps))].join('')),metronome.core.text(cljs.core.deref(seconds_elapsed)),metronome.core.checkbox("Countdown?",cljs.core.deref(countdown_QMARK_),(function (p1__35753_SHARP_){
return p1__35753_SHARP_.stopPropagation(cljs.core.reset_BANG_(countdown_QMARK_,cljs.core.not(cljs.core.deref(countdown_QMARK_))));
}))], null);
});
var destroy__28531__auto___35762 = (function (){
return clearInterval(timer_fn);
});
if(reagent.ratom.reactive_QMARK_()){
if((with_let35757.destroy == null)){
(with_let35757.destroy = destroy__28531__auto___35762);
} else {
}
} else {
destroy__28531__auto___35762();
}
