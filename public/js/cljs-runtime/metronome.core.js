...
var G__35107_35119 = cljs.core.deref(countdown_value);
(speak.cljs$core$IFn$_invoke$arity$1 ? speak.cljs$core$IFn$_invoke$arity$1(G__35107_35119) : speak.call(null,G__35107_35119));
...
var G__35108 = cljs.core.deref(seconds);
return (speak.cljs$core$IFn$_invoke$arity$1 ? speak.cljs$core$IFn$_invoke$arity$1(G__35108) : speak.call(null,G__35108));
}
}
}),(1000)));
});
metronome.core.on_row_click = (function metronome$core$on_row_click(p__35109){
...
var seconds = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35110__$1,new cljs.core.Keyword(null,"seconds","seconds",-445266194));
var timer_fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35110__$1,new cljs.core.Keyword(null,"timer-fn","timer-fn",-731279340));
var running = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35110__$1,new cljs.core.Keyword(null,"running","running",1554969103));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35110__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var reps = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35110__$1,new cljs.core.Keyword(null,"reps","reps",1391310856));
var countdown_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35110__$1,new cljs.core.Keyword(null,"countdown?","countdown?",-1555952325));
var countdown_value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35110__$1,new cljs.core.Keyword(null,"countdown-value","countdown-value",-908866158));
return (function (){
...
metronome.core.counter_row = (function metronome$core$counter_row(p__35114){
...
var desc = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35115__$1,new cljs.core.Keyword(null,"desc","desc",2093485764));
var bg_color = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35115__$1,new cljs.core.Keyword(null,"bg-color","bg-color",455102491));
var cadence = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__35115__$1,new cljs.core.Keyword(null,"cadence","cadence",821204241));
var with_let35117 = reagent.ratom.with_let_values(new cljs.core.Keyword(null,"with-let35117","with-let35117",1805083321));
var temp__5739__auto___35120 = reagent.ratom._STAR_ratom_context_STAR_;
if((temp__5739__auto___35120 == null)){
} else {
var c__28532__auto___35121 = temp__5739__auto___35120;
if((with_let35117.generation === c__28532__auto___35121.ratomGeneration)){
...
(with_let35117.generation = c__28532__auto___35121.ratomGeneration);
}


var init35118 = (with_let35117.length === (0));
var seconds_elapsed = ((init35118)?(with_let35117[(0)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let35117[(0)]));
var running = ((init35118)?(with_let35117[(1)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let35117[(1)]));
var timer_fn = ((init35118)?(with_let35117[(2)] = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(null)):(with_let35117[(2)]));
var reps = ((init35118)?(with_let35117[(3)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((0))):(with_let35117[(3)]));
var countdown_QMARK_ = ((init35118)?(with_let35117[(4)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(false)):(with_let35117[(4)]));
var countdown_value = ((init35118)?(with_let35117[(5)] = reagent.core.atom.cljs$core$IFn$_invoke$arity$1((3))):(with_let35117[(5)]));
var res__28533__auto__ = (function (){
return new cljs.core.PersistentVector(null, 6, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"class","class",-2030961996),["h-full flex flex-col flex-1 ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(bg_color)," ",metronome.core.get_bg_opacity(seconds_elapsed,cadence)," justify-evenly"].join(''),new cljs.core.Keyword(null,"on-click","on-click",1632826543),metronome.core.on_row_click(new cljs.core.PersistentArrayMap(null, 7, [new cljs.core.Keyword(null,"seconds","seconds",-445266194),seconds_elapsed,new cljs.core.Keyword(null,"timer-fn","timer-fn",-731279340),timer_fn,new cljs.core.Keyword(null,"running","running",1554969103),running,new cljs.core.Keyword(null,"cadence","cadence",821204241),cadence,new cljs.core.Keyword(null,"reps","reps",1391310856),reps,new cljs.core.Keyword(null,"countdown?","countdown?",-1555952325),countdown_QMARK_,new cljs.core.Keyword(null,"countdown-value","countdown-value",-908866158),countdown_value], null))], null),metronome.core.text(desc),metronome.core.text(["Reps:",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.deref(reps))].join('')),metronome.core.text(cljs.core.deref(seconds_elapsed)),metronome.core.checkbox("Countdown?",cljs.core.deref(countdown_QMARK_),(function (p1__35113_SHARP_){
return p1__35113_SHARP_.stopPropagation(cljs.core.reset_BANG_(countdown_QMARK_,cljs.core.not(cljs.core.deref(countdown_QMARK_))));
}))], null);
});
var destroy__28531__auto___35122 = (function (){
return clearInterval(timer_fn);
});
if(reagent.ratom.reactive_QMARK_()){
if((with_let35117.destroy == null)){
(with_let35117.destroy = destroy__28531__auto___35122);
} else {
}
} else {
destroy__28531__auto___35122();
}

return res__28533__auto__;
});
metronome.core.home_page = (function metronome$core$home_page(){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"w-screen h-screen flex flex-col"], null),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"header","header",119441134),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"h-20 bg-gray-800 flex flex-row w-fill px-10"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"self-center justify-self-center text-gray-300 flex flex-row flex-1 font-medium text-center"], null),"X3 METRONOME"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"span","span",1394872991),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"self-center text-center text-gray-300 flex-1 font-medium"], null),"TAP TO START"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),"self-center justify-self-end flex-1 text-right"], null)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [metronome.core.counter_row,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"desc","desc",2093485764),"2U2D",new cljs.core.Keyword(null,"bg-color","bg-color",455102491),"bg-purple-600",new cljs.core.Keyword(null,"cadence","cadence",821204241),(4)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [metronome.core.counter_row,new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"desc","desc",2093485764),"3U3D",new cljs.core.Keyword(null,"bg-color","bg-color",455102491),"bg-red-600",new cljs.core.Keyword(null,"cadence","cadence",821204241),(6)], null)], null)], null);
});
